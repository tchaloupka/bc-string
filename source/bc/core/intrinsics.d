...
version(LDC)
{
    ...
    version (X86_64) version = LDC_X86;
    else version (X86) version = LDC_X86;

    version (LDC_X86)
    {
        // x86 SIMD intrinsics - importing `ldc.gccbuiltins_x86` on a non-x86
        // LDC target emits "-sse4.2 not recognized" warnings, so keep it x86-only.
